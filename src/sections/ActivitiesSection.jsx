...
import TimelineItem from './TimelineItem'; // ดึงมาใช้
  ...
  return (
    <div className="max-w-6xl mx-auto px-6">
      ...
      <div className="text-center mb-24 space-y-8">
        ...
        <h2 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#bf953f] via-[#fcf6ba] to-[#aa771c] leading-tight">
          "ช่วยเพื่อให้เขา... ช่วยเหลือตนเองได้"
        </h2>
        
        <div className="bg-[#2a0e38]/40 backdrop-blur-sm rounded-2xl p-8 max-w-4xl mx-auto border border-[#b38728]/30">
        ...
        <div className="inline-flex items-center gap-3 bg-[#2a0e38]/60 py-3 px-6 rounded-full border border-[#b38728]/50">
